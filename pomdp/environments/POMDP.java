...
public class POMDP implements Serializable{
	...
	public void printObservations() {
		for (int iAction = 0; iAction < m_cActions; iAction++) {
			System.out.println("O : " + getActionName(iAction));
			...
			for (int iState = 0; iState < m_cStates; iState++) {
				...
				for (int iObservation = 0; iObservation < m_cObservations; iObservation++) {
					System.out.print(O(iAction, iState, iObservation) + " ");
				}
				System.out.println();
			}
			System.out.println();
	...
	public String getActionName( int iAction ){
		if( m_vActionNames != null ){
			return ( m_vActionNames.get(iAction) ).toString();
		}
		return "" + iAction;
	}
...
*/
	 ...
	 * @param bExplore - specifies whther the agent explores.
	 * @param vBeliefPoints - specifies whether belief states are computed through the trial.
	 * @return
	 */
