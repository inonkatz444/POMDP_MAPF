...
public class FBR {
	...
	if (DD.PRUNE_TYPE != DD.REPLACE_RANGE) {
	    // Handle Integer
	    return _context.getVarNode(gid, low, high);
	...
	if (DD.PRUNE_TYPE != DD.REPLACE_RANGE) {
	    // Handle Integer
	    return _context.getConstantNode(val);
	...
	if (DD.PRUNE_TYPE != DD.REPLACE_RANGE) {
	    // Handle Integer
	    return _context.buildDDFromUnorderedTree(l, var2ID);
	...
	if (DD.PRUNE_TYPE != DD.REPLACE_RANGE) {
	    // Handle Integer
	    return _context.buildDDFromOrderedTree(l, var2ID);
	...
	if (DD.PRUNE_TYPE != DD.REPLACE_RANGE) {
	    ...
	    return _context.applyInt(i1.intValue(), i2.intValue(), op);
	...
	if (DD.PRUNE_TYPE != DD.REPLACE_RANGE) {
	    // Handle Integer
	    Integer i = (Integer)id;
	    return _context.opOut(i.intValue(), gid, op);
	...
	if (DD.PRUNE_TYPE != DD.REPLACE_RANGE) {
	    // Handle Integer
	    Integer i = (Integer)id;
	    return _context.restrict(i.intValue(), gid, op);
	...
	if (DD.PRUNE_TYPE != DD.REPLACE_RANGE) {
	    // Handle Integer
	    Integer i = (Integer)id;
	    return _context.remapGIDsInt(i.intValue(), gid_map);
	...
	if (DD.PRUNE_TYPE != DD.REPLACE_RANGE) {
	    // Handle Object
	    Integer i = (Integer)id;
	    return _context.scalarMultiply(i.intValue(), val);
	...
	if (DD.PRUNE_TYPE != DD.REPLACE_RANGE) {
	    // Handle Integer
	    Integer i = (Integer)id;
	    return _context.scalarAdd(i.intValue(), val);
	...
	if (DD.PRUNE_TYPE != DD.REPLACE_RANGE) {
	    // Handle Integer
	    Integer i = (Integer)id;
	    return _context.invert(i.intValue());
	...
	if (DD.PRUNE_TYPE != DD.REPLACE_RANGE) {
	    // Handle Integer
	    Integer i = (Integer)id;
	    return _context.negate(i.intValue());
	...
	if (DD.PRUNE_TYPE != DD.REPLACE_RANGE) {
	    ...
	    Integer i = (Integer)id;
	    return _context.pruneNodes(i.intValue());
