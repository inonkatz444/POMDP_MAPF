...
public class MultipleAlgortihmsTest {
	...
	public static void runMultipleAlgorithms( String sModelName, String sPath, String sMethods ){
		try{
				...
				if( sMethodName.equals( "Pruning" ) ){
					...
					if( sMethodName.equals( "PVI" ) ){
						...
						*/
						...
						viAlgorithm = new HeuristicSearchValueIteration( pomdp );
					}
					else if( sMethodName.equals( "HSVIR" ) ){
						viAlgorithm = new HeuristicSearchValueIteration( pomdp, 0.1 );
					}
			...
			System.out.println( "free " + rt.freeMemory() / 1000000 + ", total " + rt.totalMemory() / 1000000 + ", max " + rt.maxMemory() / 1000000 );
			pomdp = null;
	...
	public static void main(String[] args ){
		...
		System.out.println( "All threads terminated - exiting!" );
		System.exit( 0 );
