...
public class TabularBeliefState extends BeliefState {
	...
	public TabularBeliefState( int cStates, int cActions, int cObservations, int id, boolean bSparse, boolean bCacheBelifStates, BeliefStateFactory bsFactory ){
		super( cStates, cActions, cObservations, id, bCacheBelifStates, bsFactory );
		m_bSparse = bSparse;		
